...
Supports MiMo, GPT, Claude, DeepSeek via OpenAI-compatible endpoints.
"""
...
class ResearchConfig:
    ...
    # Token budget estimates (for MiMo application claims)
    @property
...
# MiMo-specific presets
MIMO_PRESETS = {
    "mimo-turbo": LLMConfig(
        base_url="https://api.mimo.xiaomi.com/v1",
        model="MiMo-7B-RL",
        temperature=0.3,
        max_tokens=4096,
    ),
    "mimo-deepseek": LLMConfig(

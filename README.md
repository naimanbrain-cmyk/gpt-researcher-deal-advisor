# 💼 GPT-Researcher + Deal Advisor Intelligence Engine

> This fork extends GPT-Researcher with an autonomous investment/deal research layer.

The **Deal Advisor Intelligence Engine** turns a company or startup investment question into an investment-grade memo with:

- autonomous due-diligence research planning,
- 7-dimension scoring (market, team, product, traction, moat, financials, risk),
- evidence-backed confidence estimates,
- professional markdown memo generation with scorecard,
- OpenAI-compatible provider configuration,
- reproducible demo with sample outputs.

## Quick Demo

```bash
python -m deal_advisor.cli \
  --task examples/deal_advisor_task.json \
  --output examples/sample_outputs/perplexity_deal_memo.md \
  --print-plan
```

Sample output: `examples/sample_outputs/perplexity_deal_memo.md`

## Provider Config

```bash
export DEAL_ADVISOR_BASE_URL="https://api.deepseek.com/v1"
export DEAL_ADVISOR_API_KEY="your_api_key"
...
- `docs/deal-advisor-architecture.md`

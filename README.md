# 💼 Deal Advisor Intelligence Engine — MiMo 100T Fork

> This fork customizes GPT-Researcher into a MiMo-compatible autonomous investment/deal research system.

The **Deal Advisor Intelligence Engine** turns a startup/company investment question into an investment-grade memo with:

- autonomous due-diligence research plan,
- market/team/product/traction/moat/financial/risk scoring,
- conservative confidence estimates,
- markdown memo generation,
- MiMo/OpenAI-compatible endpoint configuration,
- reproducible demo task and sample output.
